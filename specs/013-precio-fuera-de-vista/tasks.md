...
- [x] T030 Poner `specs/013-precio-fuera-de-vista/plan.md` en `status: completed` **después** de commitear el resto — el sensor de cobertura rebota el commit si el plan ya está cerrado **HECHO el 2026-08-30**, después del commit `ebc1fa0`. **T026, T027 y T029 quedan sin correr y sin tildar**, con el detalle en el cierre del plan: son verificación de trabajo entregado, no deuda, así que no van al tracker
