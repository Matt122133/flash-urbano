...
|---|---|---|---|
| 12 | Dominio | **Aprobado, comprado y dado de alta.** `flashurbano.uy`, comprado el 2026-08-08 a través de hostingmontevideo.com —agente registrador acreditado— a **USD 9.85 + IVA ≈ USD 12 el primer año**, con **renovación confirmada en USD 13.50 al año** desde el segundo (USD 16.47 con IVA, dentro del tope de USD 20 que aprobó Diego). Descartado el canal directo de nic.uy (SeCIU/UdelaR): USD 25 al año por el mismo dominio, se pasa del tope. Descartado `flashurbano.com`, tomado desde 2025-07-07 y parkeado para reventa. **Titular: Mateo**, decidido así con Diego el 2026-08-09. Consecuencia si algún día tiene que pasar a Diego: nic.uy cobra USD 33 por el cambio de titularidad, más que el dominio. Estado operativo del DNS —hoy la zona no existe y nada resuelve— en [`processes/dominio-y-dns.md`](processes/dominio-y-dns.md). | 2026-08-09 |
| 13 | Costo de hosting | **Aprobado el 2026-08-09.** El backend corre en Railway con el plan **Hobby: USD 5/mes de abono + el excedente de uso** — para esta carga (un servicio Go chico y un Postgres, los dos 24/7) la estimación da alrededor de **USD 6-7 al mes**, o sea unos USD 75-85 al año. El abono **no es un techo**: los USD 5 incluyen USD 5 de crédito de uso y lo que se consuma por encima se factura aparte. Diego dio el ok al gasto recurrente. Queda abierta la duda de si Hobby cubre uso comercial; está registrada en [`tech-debt-tracker.md`](tech-debt-tracker.md) y **no bloquea** el despliegue. | 2026-08-09 |
| 1 | Quién puede pedir | **Confirmada la lectura del ADR.** Cotizar queda abierto: cualquiera entra, pone calle y esquina y ve el precio sin cuenta. Crear el pedido exige estar logueado, con cuenta de Google o con un registro en el sistema propio. No hay pedido anónimo y no hay aprobación manual de Diego. ~~**Consecuencia que hay que resolver aparte: elimina el pedido como invitado, que la constitución todavía nombra en *Scope boundaries*.**~~ **Resuelto el 2026-08-11**: la constitución pasa a **v3.0.0** y dice *"No package is created without an identified customer"*. MAJOR porque revierte una capacidad que el documento concedía, no porque acote alcance. La puerta la implementa `007`. | 2026-08-08 |
